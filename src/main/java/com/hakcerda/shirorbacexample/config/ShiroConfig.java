package com.hakcerda.shirorbacexample.config;

import com.hakcerda.shirorbacexample.controller.RestFilter;
import com.hakcerda.shirorbacexample.model.JWTToken;
import com.hakcerda.shirorbacexample.service.JWTReleam;
...
public class ShiroConfig {
    ...
    @Bean
    public JWTReleam JWTRealm(UserService userService){
        JWTReleam jwtReleam = new JWTReleam();
        jwtReleam.setUserService(userService);
    ...
    public ShiroFilterFactoryBean factory(DefaultWebSecurityManager securityManager) {
        ...
        filterRuleMap.put("/**", RestFilter.NAME);
